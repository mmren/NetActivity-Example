...
public class MyDownTime extends CountDownTimer
{
    ...
    public MyDownTime(long millisInFuture, long countDownInterval, Context context, TextView tvCode)
    {
    ...
    public void onTick(long millisUntilFinished)
    {
        ...
        tvCode.setText(context.getResources().getString(R.string.register_get_again_later,
    ...
    public void onFinish()
    {
        ...
        tvCode.setText(context.getString(R.string.register_send_code));
